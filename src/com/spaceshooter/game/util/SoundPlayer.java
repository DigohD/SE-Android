...
public class SoundPlayer {
	...
	public SoundPlayer(Activity activity) {
		...
		sounds.put(SoundID.nullValue,
				soundPool.load(activity, com.spaceshooter.game.R.raw.laser, 1));

		sounds.put(SoundID.ui_guns, soundPool.load(activity,
				com.spaceshooter.game.R.raw.ui_guns, 1));

		sounds.put(SoundID.exp_1,
				soundPool.load(activity, com.spaceshooter.game.R.raw.exp_1, 1));
		sounds.put(SoundID.exp_2,
				soundPool.load(activity, com.spaceshooter.game.R.raw.exp_2, 1));

		sounds.put(SoundID.fire_RedPlasma, soundPool.load(activity,
				com.spaceshooter.game.R.raw.fire_redplasma, 1));
		sounds.put(SoundID.fire_BluePlasma, soundPool.load(activity,
				com.spaceshooter.game.R.raw.fire_blueplasma, 1));
		sounds.put(SoundID.fire_GreenPlasma, soundPool.load(activity,
				com.spaceshooter.game.R.raw.fire_greenplasma, 1));
		sounds.put(SoundID.fire_YellowPlasma, soundPool.load(activity,
				com.spaceshooter.game.R.raw.fire_yellowplasma, 1));

		sounds.put(SoundID.hit_RedPlasma, soundPool.load(activity,
				com.spaceshooter.game.R.raw.hit_redplasma, 1));
		sounds.put(SoundID.hit_BluePlasma, soundPool.load(activity,
				com.spaceshooter.game.R.raw.hit_blueplasma, 1));
		sounds.put(SoundID.hit_GreenPlasma, soundPool.load(activity,
				com.spaceshooter.game.R.raw.hit_greenplasma, 1));
		sounds.put(SoundID.hit_YellowPlasma, soundPool.load(activity,
				com.spaceshooter.game.R.raw.hit_yellowplasma, 1));
	}
	...
	// mp[0].create(context, com.spaceshooter.game.R.raw.laser);
	// mp[0].start();
	// // return;
	// // }
	// }
