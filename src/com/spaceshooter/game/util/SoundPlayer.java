...
public class SoundPlayer {
	...
	public SoundPlayer(Activity activity){
	    ...
	    sounds.put(SoundID.fire_YellowPlasma, soundPool.load(activity, com.example.se_android.R.raw.fire_yellowplasma, 1));
	    ...
	    sounds.put(SoundID.hit_YellowPlasma, soundPool.load(activity, com.example.se_android.R.raw.hit_yellowplasma, 1));
	}
