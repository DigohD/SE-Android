...
public class Vector2f {
	...
	/**
	 * Normalizes the vector (turning it into the unit vector)
	 * a unit vector is a vector which has a magnitude of one 
	 * Useful do determine the direction of entities, often used as the direction vector
