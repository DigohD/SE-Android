...
public class BackGround extends DynamicObject{
	...
	public void draw(Canvas canvas,  float interpolation) {
		...
		canvas.drawBitmap(bitmap, interpolatedPosition.x , interpolatedPosition.y + yOffset2, null);
		canvas.drawBitmap(bitmap, interpolatedPosition.x , interpolatedPosition.y + yOffset1, null);
		
//		canvas.drawBitmap(bitmap, interpolatedPosition.x + xOffset2, interpolatedPosition.y, null);
//		canvas.drawBitmap(bitmap, interpolatedPosition.x + xOffset1, interpolatedPosition.y, null);
