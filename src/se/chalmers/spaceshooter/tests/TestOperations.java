...
public class TestOperations extends TestCase {
	...
	public void testGameObjectManager() {
		...
		Emitter em = new RadialEmitter(20, ParticleID.DUST,
	...
	public void testProjectileOutOfBound() {
		...
		Projectile p2 = new BluePlasma(new Vector2f(GameView.WIDTH / 2, -12),
				12, 12);
		Projectile p3 = new GreenPlasma(new Vector2f(GameView.WIDTH / 2,
				GameView.HEIGHT + 12), 30, 12);
		Projectile p4 = new MantisProj(new Vector2f(-20, GameView.HEIGHT / 2),
				20, 2);
		Projectile p5 = new PredatorProj(
				new Vector2f(-20, GameView.HEIGHT / 2), 20, 5);
