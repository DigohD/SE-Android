package se.chalmers.spaceshooter.animation;
...
public class Animation {
	...
	public Animation(Bitmap bitmap, int numOfBitmaps, int animSpeed){
		...
		for(int i = 0; i < numOfBitmaps; i++)
			bitmaps.add(BitmapHandler.getSubBitmap(bitmap, i*width, 0, width, height));
	...
	public void animate(){
		...
		if(currentFrame == bitmaps.size()) currentFrame = 0;
	}
