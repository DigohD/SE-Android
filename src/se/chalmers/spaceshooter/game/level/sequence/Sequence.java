...
/**
 * Class for creating the enemies in a sequence. You create a image with a black
 * background then place out pixels of different colors which will represent the
...
public class Sequence {
	...
	private int[] pixels;
	// used to check whether it is necessary to calculate a larger timeinterval
	// for the sequence
	...
	// maps pixelcolor to an arraylist containing the positions of all the
	// pixels with that specific color
	 ...
	 * enemies with that color key to their correct positions Also calls the
	 * addtomanagerlists method which simply adds the enemies to one list for
	 * collision detection and one for drawing and updating
	 */
