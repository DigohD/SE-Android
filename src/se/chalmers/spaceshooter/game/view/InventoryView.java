			...
			switch (weapon) {
				case 0:
					GameObjectManager.getPlayer().setBottomGun(
							new RedPlasmaGun(GameObjectManager.getPlayer().getBottomGunPos()));
					GameObjectManager.getPlayer().setTopGun(
							new RedPlasmaGun(GameObjectManager.getPlayer().getTopGunPos()));
					break;
				case 1:
					GameObjectManager.getPlayer().setBottomGun(
							new BluePlasmaGun(GameObjectManager.getPlayer().getBottomGunPos()));
					GameObjectManager.getPlayer().setTopGun(
							new BluePlasmaGun(GameObjectManager.getPlayer().getTopGunPos()));
					break;
				case 2:
					GameObjectManager.getPlayer().setBottomGun(
							new GreenPlasmaGun(GameObjectManager.getPlayer().getBottomGunPos()));
					GameObjectManager.getPlayer().setTopGun(
							new GreenPlasmaGun(GameObjectManager.getPlayer().getTopGunPos()));
					break;
				case 3:
					GameObjectManager.getPlayer().setBottomGun(
							new YellowPlasmaGun(GameObjectManager.getPlayer().getBottomGunPos()));
					GameObjectManager.getPlayer().setTopGun(
							new YellowPlasmaGun(GameObjectManager.getPlayer().getTopGunPos()));
					break;
			}
			start = true;
		}
